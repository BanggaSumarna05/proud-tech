  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-44 right-6 md:right-28 text-brand-lime pointer-events-none animate-pulse"
      >
      ...
      <div className="max-w-6xl w-full z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-4">
        ...
        <div className="flex-1 text-center lg:text-left flex flex-col items-center lg:items-start">
          ...
          <motion.h1
            ...
            className="font-display font-black text-3xl sm:text-5xl md:text-6xl lg:text-7xl leading-[0.95] tracking-tighter text-brand-dark uppercase"
          >
            {t("hero.line1")} <br className="hidden md:block" />
            <span className="text-white bg-brand-blue px-4 md:px-6 md:py-1 py-0.5 mx-2 rounded-2xl border border-brand-blue/30 shadow-lg inline-block transform -rotate-1">
          ...
          >
            ...
            >
              {t("hero.btn_start")}
              <span className="w-6 h-6 rounded-full bg-brand-lime text-brand-blue flex items-center justify-center group-hover:bg-white group-hover:text-brand-dark transition-colors">
            ...
            >
              {t("hero.btn_view")}
              <ChevronRight className="w-4 h-4 text-brand-blue group-hover:text-brand-lime transition-colors" />
            </button>
          </motion.div>
        </div>
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <span className="w-2.5 h-2.5 rounded-full bg-brand-lime border border-brand-blue" />
        ...
        <div className="flex items-center gap-4 md:justify-center border-l-0 md:border-l border-brand-border/60 pl-0 md:pl-6">
          ...
          <div>
            <div className="font-display font-black text-2xl text-brand-dark leading-none">50+</div>
        ...
        {/* Stat Item 2 */}
        <div className="flex items-center gap-4 md:justify-center border-l-0 md:border-l border-brand-border/60 pl-0 md:pl-6">
          <div className="w-10 h-10 rounded-full bg-brand-lime/15 flex items-center justify-center text-brand-blue">
            <Users className="w-5 h-5" />
          </div>
          <div>
            <div className="font-display font-black text-2xl text-brand-dark leading-none">20+</div>
